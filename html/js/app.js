const Targeting = Vue.createApp({
    data() {
        return {
            ...
            StandardEyeIcon: "fa fa-cog fa-spin fa-3x fa-fw", // This is the default eye icon
            CurrentIcon: this.StandardEyeIcon, // leave this
            SuccessColor: "rgb(0, 183, 255)", // This is the color when the target has found the option
